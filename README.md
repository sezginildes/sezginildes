...
`Excel (Advanced)` `Power BI` `SPSS` `Python` `Notion` `Supabase` `Gemini AI` `GitHub Pages`
...
- 🏫 L&D Specialist & Development Coach @ Nazmi Arıkan Fen Bilimleri
- 🌱 Building real-time dashboards with Power BI
- 🔍 Open to **People Development**, **L&D Specialist**, and **OD** roles at corporate organizations
...
*Istanbul, Türkiye · People Development · Learning & Development · Behavioral Science*
